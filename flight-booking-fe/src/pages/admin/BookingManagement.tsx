                    ...
                    <div className="px-5 py-4 border-t border-gray-100 bg-gray-50 flex items-center justify-between">
                        ...
                        <div className="flex gap-1">
                            <button
                                ...
                                className="px-3 py-1.5 text-xs font-bold text-gray-600 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition"
                            >
                                Trước
                            </button>
                            ...
                            {Array.from({ length: totalPages }).map((_, i) => (
                                <button
                                    ...
                                    className={`px-3 py-1.5 text-xs font-bold rounded-lg border transition ${currentPage === i + 1 ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50'}`}
                                >
                                    {i + 1}
                                </button>
                            ))}
